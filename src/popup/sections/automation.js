...
export default ({ getSwitchProps }) => (
  <React.Fragment>
    ...
    />
    <ListItemSwitch
      primary="Smurf Detection"
      secondary="Detect potential smurf accounts based on player statistics and display badges next to suspicious players."
      {...getSwitchProps('matchRoomSmurfDetection')}
    />
