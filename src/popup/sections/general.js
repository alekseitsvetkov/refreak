    ...
    <React.Fragment>
      ...
      {typeof hasFaceitBetaHostPermission === 'boolean' &&
        typeof extensionEnabledFaceitBeta === 'boolean' && (
          <ListItemSwitch
            primary="Enabled"
            secondary="FACEIT Beta (beta.faceit.com) will be enhanced. Please note that the FACEIT Beta may contain errors or inaccuracies and may not function as well as standard FACEIT (www.faceit.com). If you experience any issues with Refreak, please report them on Reddit or Twitter."
            onClick={async () => {
