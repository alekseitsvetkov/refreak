    ...
    <div className="h-screen flex justify-center items-center">
      <div className="w-96 space-y-4 text-center">
        ...
        {hasRequiredPermissions ? (
          <p>
            Please access the Refreak settings by clicking on the Refreak icon
            in your browser extensions toolbar.
          </p>
        ) : (
          <>
            <div className="space-y-2">
              ...
              <p>
                ...
                Refreak won't work as expected.
              </p>
              <p>
                Your privacy and security are very important to us. Refreak will
            ...
            <div className="flex justify-center text-neutral-600 gap-4">
              ...
              <a
                href="https://reddit.com/r/refreakgg"
                target="_blank"
                rel="noreferrer noopener"
                className="transition hover:text-white"
              >
