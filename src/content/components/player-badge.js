...
export default ({ level = 0, role, bgColor, textColor, onClick }) => {
  ...
  switch (role) {
    case 'Creator': {
      description = 'Has created Refreak'
      break
    }
    case 'Developer': {
      description = 'Is part of Refreak developer team'
      break
    }
    case 'Code Contributor': {
      description = 'Has contributed to Refreak code'
      break
    }
    default: {
      description = 'Has supported Refreak'
    }
  }
